                ...
                <div className='seriesForm'>
                    <Form {...formlayout}>
                        ...
                        <Form.Item name="专题插图" label="专题插图">
                            <div className='flex'>
                                <div className='seriesBanner m-r-10'></div>
                    ...
                    <div className='series-step2-content'>
                        <div className='flex-between'>
                            <div className='flex-center'>
                                <div>网红评选</div>
                                <div className='flex-center m-l-20'><div className='dot-yellow'></div>进行中</div>
                            </div>
                ...
                <div className='series-step2-block'>
                    ...
                    <div className='series-step2-content'>
                        <div className='flex-between'> 
                            <div className='flex-center'>
                                <div>网红评选</div>
                                <div className='flex-center m-l-20'><div className='dot-green'></div>进行中</div>
                            </div>
                            <div>
                            ...
                            <div className='ripple-black flex-center default-button m-t-10'>
                                <ArrowUpOutlined />
                                上移
                            </div>
                            <div className='ripple-black flex-center default-button m-t-10'>
...
function SeriesListPage() {
    const {currectStep, setCurrectStep} = useContainer(SeriesListPageStore)
    return  <div className='page seriesEdit-page m-b-30'>
        ...
        <div className='flex-center m-t-20'>
            ...
            <Button className='m-r-10' type="primary">分享发布</Button>
        </div>
    </div>
}
