                ...
                <Card 
                    ...
                    <div  style={{borderColor: '#0BBA97'}} className='accountType-card-body flex-column-center'>
                        ...
                        <div className='function-list'>
                            <div>
                                <div className='flex-center m-b-20 text_title_small'>基本功能</div>
            ...
            <Card 
                ...
                className='accountType-card'>
                    ...
                    className='accountType-card-body flex-column-center'>
                        ...
                        <div className='flex-center  m-b-70'>
                        </div>
 ...
 */
function PayForm() {
    return <div className='account-payform m-t-50'>
        <div className='flex'>
        ...
        <div className='flex m-t-40'>
            <Row>
                <Col><div className='account-payform-label text m-b-10'>开通时长</div></Col>
        ...
        <div className='flex m-t-30'>
            ...
            <div className='account-payform-text text'>
                ¥ 0.00 余额不足 <span className='m-l-10 color-primary'>去充值</span>
            </div>
        </div>
    </div>
} 
...
function  AccountUpgradePage() {
    return <div className='page accountUpgrade-page m-b-30'>
